...
function modifier_item_manta_datadriven_invulnerability_on_destroy(keys)
	...
	local illusion1_direction = 3
	local illusion2_direction = 4  --This will ensure that the illusions will spawn in different directions.
