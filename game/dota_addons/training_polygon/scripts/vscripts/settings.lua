...
TREE_REGROW_TIME = 9999999999999.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
FORCE_PICKED_HERO = "npc_dota_hero_largo"                 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
...
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 231, 0, 12 }   --    Yellow
